...
class Company:
    ...
    def __repr__(self):
        return f'{self.company_name} company is founded at {self.founded_at} and has {self.employees_count} eployees'
...
class Job:
    ...
    def __repr__(self):
        return f'Working at {self.company} company as {self.position} with {self.salary} salary and have {self.experience_year} years of experience'
